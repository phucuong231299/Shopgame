...
<div class="card" >
    <div class="card-body">
        <form action="{{route('bia.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
              ...
              <textarea type="text" style="width: 100%;height: 150px;" name="tomtat" id="tomtat" cols="10" rows="1"></textarea>
              <div class="invalid-feedback"></div>
            </div>
