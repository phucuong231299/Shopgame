                        ...
                        <form  method="post">
                          ...
                          <div class="form-group">
                              <label for="hoten" class="form-label">Họ và tên</label>
                                <input style="color: black;" disabled value="{{Auth::guard('khachhang')->user()->hoten}}" type="text" required class="form-control" >
                            </div>
                            <div class="form-group">
                              <label for="diachi" class="form-label">Địa chỉ</label>
                                <input style="color: black;" disabled value="{{Auth::guard('khachhang')->user()->diachi}}" class="form-control" required type="text" >
                            </div>
                            <div class="form-group">
                              <label for="sdt" class="form-label">SĐT</label>
                                <input style="color: black;" disabled value="{{Auth::guard('khachhang')->user()->sdt}}" class="form-control" required type="number" >
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                           ...
                           @if (Auth::guard('khachhang')->user()->gioitinh==0)
                              <a style="color: white">Nam</a> 
                           
                            @else
                            <a style="color: white">Nữ</a> 
                            
                           @endif
                        </div>
                        <div class="form-group">
                            <label for="diachi" class="form-label">Ngày sinh</label>
                              <input style="color: black;" disabled value="{{Auth::guard('khachhang')->user()->ngaysinh}}" class="form-control" required type="date" >
                        </div>
                        <div class="form-group">
                            <label for="diachi" class="form-label">CMND</label>
                              <input style="color: black;" disabled value="{{Auth::guard('khachhang')->user()->cmnd}}" class="form-control" required type="text" >
                        </div>
                        <div class="form-group">
                            <label for="email" class="form-label">Email</label>
                            <input style="color: black;" disabled value="{{Auth::guard('khachhang')->user()->email}}" class="form-control" required type="text"  >
                          </div>
                    ...
                    <div class="modal fade" id="thongtin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{route('khachhang.update', $khachhang->id)}}" method="POST" id="upload-form" enctype="multipart/form-data">
                                    @csrf
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="hoten" type="text" value="{{$khachhang->hoten}}" class="form-control" id="hoten" name="hoten" required>
                                            {{$errors->first('hoten')}}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="sdt" class="form-label">SĐT</label>
                                            <input id="sdt"  value="{{$khachhang->sdt}}" type="text"  class="form-control" id="sdt" name="sdt" required >
                                            {{$errors->first('sdt')}}
                                        </div>
                                        <div class="form-group">
                                            <label for="cmnd" class="form-label">CMND</label>
                                            <input  id="cmnd" value="{{$khachhang->cmnd}}" type="text"  class="form-control" id="cmnd" name="cmnd" required>
                                            {{$errors->first('cmnd')}}
                                        </div>
                                        <div class="form-group">
                                            <label for="ngaysinh" class="form-label">Ngày sinh</label>
                                            <input id="ngaysinh" value="{{$khachhang->ngaysinh}}" type="date"  class="form-control" id="ngaysinh" name="ngaysinh" required>
                                            {{$errors->first('ngaysinh')}}
                                        </div>
                            
                                        <div class="form-group">
                                            <label for="diachi" class="form-label">Địa chỉ</label>
                                            <input id="diachi" value="{{$khachhang->diachi}}" type="text"  class="form-control" id="diachi" name="diachi" required>
                                            {{$errors->first('diachi')}}
                                        </div>
                                        <div class="form-group">
                                            <label for="diachi" class="form-label">Email</label>
                                            <input id="email" value="{{$khachhang->email}}" type="email"  class="form-control" id="diachi" name="email" required>
                                            {{$errors->first('email')}}
                                        </div>
