...
@section('main')
    <br>
    <h1 class="title page-title">Phụ Kiện Playstation </h1>
{{-- <div class="main_content"> --}}
          <div class="row">
        @foreach ($sanpham as $item)
      @if ($item->hang->id==1 &&$item->loai->id==3)
    ...
    <br>
    <h1 class="title page-title">Phụ Kiện Nintendo </h1>
    {{-- <div class="main_content"> --}}
              <div class="row">
            @foreach ($sanpham as $item)
          @if ($item->hang->id==2 &&$item->loai->id==3)
                <div class="row row-cols-1 row-cols-md-3 g-4" style="width: 350px;">
                    <div class="col">
                        <div class="card h-100">
                            @if ($item->soluong >= 1)
    ...
    <br>
    <h1 class="title page-title">Phụ Kiện Xbox </h1>
    {{-- <div class="main_content"> --}}
              <div class="row">
            @foreach ($sanpham as $item)
          @if ($item->hang->id==3 &&$item->loai->id==3)
                <div class="row row-cols-1 row-cols-md-3 g-4" style="width: 350px;">
                    <div class="col">
                        <div class="card h-100">
                            @if ($item->soluong >= 1)
